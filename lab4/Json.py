...
for item in data['imdata']:
    item['l1PhysIf']['attributes']['Description'] = '--------------------'
    print(item['l1PhysIf']['attributes']['dn'],"-------",item['l1PhysIf']['attributes']['Description'],item['l1PhysIf']['attributes']['speed'],"--",item['l1PhysIf']['attributes']['mtu'])